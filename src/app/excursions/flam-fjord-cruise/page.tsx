...
import { flamFjordCruiseExcursion } from "@/lib/excursions/flam-fjord-cruise";
import { buildPageMetadata } from "@/lib/site-metadata";

const excursion = flamFjordCruiseExcursion;
...
export default function FlamFjordCruisePage() {
