...
export const metadata: Metadata = buildPageMetadata({
  title: "Terms of Use",
  description:
    "Terms of use for Flam Shore Excursions: independent cruise planning information for Flam port days.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage
      title="Terms of Use"
      lead="These terms cover use of the Flam Shore Excursions website as an independent informational planning resource."
      ...
      ctaTitle="Plan your Flam cruise day"
      ctaText="Explore railway, fjord and viewpoint options, then verify timings with your cruise line."
    ...
    >
      <section>
        ...
        <p>
          ...
          information about Flam. It is not a substitute for official cruise-line
