...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Treat 30 to 45 minutes before the published all aboard time as your personal deadline. That margin helps you return to ship on time even if a tour runs long or pier queues build.",
  },
] as const;
    ...
    >
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Departure:</strong> when the ship leaves Flam, often 30 to 60
      ...
      <section>
        ...
        <ul>
          <li>May to September: daily calls on many fjord itineraries</li>
      ...
      <section>
        ...
        <ul>
          <li>4 to 5 hours ashore: one major tour only</li>
          <li>6 to 7 hours: one tour plus village time</li>
